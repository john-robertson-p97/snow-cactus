...
kubectl create -f %~dp0..\P97.CactusBuilder.Microservice\Containers\k8s_local.yaml
kubectl create -f %~dp0..\P97.CactusMaterialSupplier.Microservice\Containers\k8s_local.yaml
kubectl create -f %~dp0..\P97.SnowmanBuilder.Microservice\Containers\k8s_local.yaml
kubectl create -f %~dp0..\P97.SnowmanMaterialSupplier.Microservice\Containers\k8s_local.yaml
