...
using P97.CactusBuilder.Microservice.Surface.Definitions;

namespace P97.CactusBuilder.Microservice.Controllers
{
    /// <summary>
    ///     The controller for building a cactus.  This is accessed via route <see
    ///     cref="UriInfo.Routes.BuildCactus"/>.
    /// </summary>
    [Route(UriInfo.Routes.BuildCactus)]
    [ApiController]
