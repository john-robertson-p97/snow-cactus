...
namespace P97.Atlas.States.Phoenix.Microservice.Controllers
{
    ...
    {
        /// <summary>
        ///     Raises an initiating event to Atlas Phoenix.  It is presumed that there is no preexisting workflow
        ...
        /// </param>
        [HttpPost]
        public void Post([FromBody] InitiatingEventDto evt) => SharedInstanceIAtlasPhoenix.IAtlasPhoenix.HandleEvent(evt);
    }
}